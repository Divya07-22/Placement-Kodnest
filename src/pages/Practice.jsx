...
import { FileText, Search, ArrowRight, Briefcase, Building } from 'lucide-react';
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="p-6 md:p-8 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            className="w-full h-48 px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all resize-none"
